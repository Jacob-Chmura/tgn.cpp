...
class TGStore:
    ...
    @staticmethod
    def from_memory(edges: Batch, node_feats: NDArray | None = None, label_n_id: NDArray | None = None, label_time: NDArray | None = None, label_target: NDArray | None = None, val_start: int | None = None, test_start: int | None = None) -> TGStore:
    ...
    def gather_timestamps(self, e_id: NDArray) -> Annotated[NDArray[numpy.int64], dict(shape=(1))]:
        """Vectorized gather of edge timestamps."""

    def gather_msgs(self, e_id: NDArray) -> Annotated[NDArray[numpy.float32], dict(shape=(2))]:
        """Vectorized gather of edge features (messages)."""

    def gather_node_feats(self, n_id: NDArray) -> Annotated[NDArray[numpy.float32], dict(shape=(2))]:
